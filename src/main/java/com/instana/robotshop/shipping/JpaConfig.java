...
public class JpaConfig {
    ...
    public DataSource getDataSource() {
        String JDBC_URL = String.format("jdbc:mysql://%s/cities?sslMode=REQUIRED&&requireSSL=true&autoReconnect=true", System.getenv("DB_HOST") == null ? "mysql" : System.getenv("DB_HOST"));
